                ...
                children: <Widget>[
                  ...
                  Flexible(
                    child: Padding(
                      ...
                      child: Text(
                        "${RulesData[RulesData.length-index-1]["Title"]}",
                        softWrap: true,
                ...
                children: <Widget>[
                  ...
                  Flexible(
                    child: Padding(
                      ...
                      child: Text(
                        "${RulesData[RulesData.length-index-1]["Description"]}",
                        softWrap: true,
                        textAlign: TextAlign.start,
                ...
                GestureDetector(
                  onTap: () {
                    _launchURL(Image_Url +
                        "${RulesData[RulesData.length-index-1]["FileAttachment"]}");
                  },
                  child: Padding(
