...
Color colorOne = appcolor;
Color colorTwo = buttoncolor;
    ...
    if (txtName.text != '' &&
      ...
      res.then((data) async {
        ...
        if (data != null && data.ERROR_STATUS == false) {
          ...
          await prefs.remove(cnst.Session.digital_Id);
          await prefs.remove(Session.Name);
          await prefs.remove(Session.Mobile);
          await prefs.remove(Session.Company);
