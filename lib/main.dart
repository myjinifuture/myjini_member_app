...
class _MyAppState extends State<MyApp> with WidgetsBindingObserver{
  ...
  Future<void> initOneSignalNotification() async {
    ...
    OneSignal.shared.inFocusDisplayType();
    Platform.isAndroid ?  OneSignal.shared.setNotificationReceivedHandler((OSNotification notification) {
     ...
     print('Received Notification in ios: ' + notification?.payload?.body ?? '');
   });
