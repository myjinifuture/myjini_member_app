...
import 'package:smart_society_new/Admin_App/Screens/EditNotice.dart';
import 'package:smart_society_new/Admin_App/Screens/NoticeDetail.dart';
  ...
  _deleteNotice() async {
    try {
      ...
      if (result.isNotEmpty && result[0].rawAddress.isNotEmpty) {
        ...
        var data = {
          "noticeId" :widget.noticeData["_id"].toString()
        };
        Services.responseHandler(apiName: "admin/deleteNotice",body: data).then(
            (data) async {
