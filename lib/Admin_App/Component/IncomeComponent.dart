              ...
              children: <Widget>[
                ...
                Expanded(
                  child: Column(
                    ...
                    children: <Widget>[
                      Text(
                        "${widget.incomeData["IncomeSource"][0]["sourceName"]}",
                        style: TextStyle(
                            fontSize: 16,
                ...
                Text(
                  "+ ${cnst.Inr_Rupee}${double.parse(widget.incomeData["credit"].toString()).toStringAsFixed(2)}",
                  style: TextStyle(
                      fontSize: 16,
