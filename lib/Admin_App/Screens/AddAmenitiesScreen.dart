...
class AddAmenitiesScreen extends StatefulWidget {
  Function onAddAmenity;
  AddAmenitiesScreen({this.onAddAmenity});
  @override
    ...
    try {
      ...
      if (result.isNotEmpty && result[0].rawAddress.isNotEmpty) {
        ...
        for (int i = 0; i < images.length; i++) {
          pickedImages += images[i].toString();
        }
        String filename = "";
        String filePath = "";
        File compressedFile;
        ...
        Services.responseHandler(
                apiName: "admin/addSocietyAmenity", body: formData)
            .then((data) async {
          setState(() {
            isLoading = false;
          });
          if (data.Data != null && data.Data.length > 0) {
            ...
            setState(() {
              ...
              //     context,
              //     MaterialPageRoute(
              //         builder: (context) => getAmenitiesScreen()));
              // Navigator.pop(context);
            });
          } else {
            setState(() {
