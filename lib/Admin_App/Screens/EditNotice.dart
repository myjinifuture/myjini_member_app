...
class _EditNoticeState extends State<EditNotice> {
  ...
  setData() {
    dateDetails=widget.noticeData["dateTime"][0].toString().split('/');
    setState(() {
    ...
    if (txtTitle.text != null &&
      ...
      try {
        ...
        if (result.isNotEmpty && result[0].rawAddress.isNotEmpty) {
          ...
          Services.responseHandler(apiName: "admin/editNotice",body: formData).then((data) async {
            // pr.hide();

            if (data.IsSuccess == true && data.Data.toString() == "1") {
              Fluttertoast.showToast(
                  msg: "Notice Edited Successfully",
