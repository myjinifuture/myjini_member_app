...
import 'package:smart_society_new/Admin_App/Common/ClassList.dart';
import 'package:smart_society_new/Admin_App/Common/ClassList.dart';
    ...
    try {
      ...
      if (result.isNotEmpty && result[0].rawAddress.isNotEmpty) {
        ...
        Services.responseHandler(apiName: "admin/getTransactionSources",body: data).then((data) async {
          print("admin/getIncomeSources api called");
          if (data.Data != null && data.Data.length > 0) {
            setState(() {
              _incomeSourceList = data.Data;
              isLoading = false;
            });
          } else {
            setState(() {
      ...
      if (_incomeSource != null && _paymentType != null) {
        try {
          ...
          if (result.isNotEmpty && result[0].rawAddress.isNotEmpty) {
            ...
            for(int i=0;i<_incomeSourceList.length;i++){
              if(_incomeSourceList[i]["sourceName"] == _incomeSource){
                incomeSourceId = _incomeSourceList[i]["_id"];
                break;
              }
            }
            var data = {
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: TextFormField(
            ...
            decoration: InputDecoration(hintText: "Income Source Name"),
    ...
    if (txtIncomeSourceName.text != "") {
      try {
        ...
        if (result.isNotEmpty && result[0].rawAddress.isNotEmpty) {
          ...
          var data = {
            "sourceName": txtIncomeSourceName.text,
            "societyId": SocietyId
          };
