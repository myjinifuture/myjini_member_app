    ...
    try {
      ...
      if (result.isNotEmpty && result[0].rawAddress.isNotEmpty) {
        ...
        Services.responseHandler(apiName: "member/getMemberRole", body: data)
          ...
          print("data");
          print(data);
          if (data.Data[0]["society"][0]["isAdmin"].toString() == "1") {
            setState(() {
  ...
  _getVisitor() async {
    try {
      ...
      if (result.isNotEmpty && result[0].rawAddress.isNotEmpty) {
        ...
        String flatId = prefs.getString(Session.FlatId);
        String wingId = prefs.getString(Session.WingId);
        var data = {
          "societyId": societyId,
          "flatId": flatId,
          "wingId": wingId,
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: Text("${widget.memberData["Name"]}".checkForNull(),
                          style: TextStyle(
                    ...
                    ListTile(
                      ...
                      title: Text(
                          "${widget.memberData["EmailId"]}".checkForNull()),
                      subtitle: Text("email"),
                    ),
                    Padding(
                      padding: const EdgeInsets.only(left: 30.0),
                    ...
                    ListTile(
                      ...
                      title: Text(
                          "${widget.memberData["CompanyName"]}".checkForNull()),
                    ...
                    ListTile(
                      ...
                      title: Text(
                          "${widget.memberData["BloodGroup"]}".checkForNull()),
