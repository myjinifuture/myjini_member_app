...
import 'package:smart_society_new/Admin_App/Component/ExpenseComponent.dart';
...
class _ExpenseState extends State<Expense> {
  ...
  _getLocaldata() async {
    ...
    _getExpenseData(
        fromDate: selectedDate.month.toString(), toDate:selectedDate.year.toString());
  }

  _getExpenseData({String fromDate,String toDate}) async {
    try {
      ...
      if (result.isNotEmpty && result[0].rawAddress.isNotEmpty) {
        ...
        Services.responseHandler(apiName: "admin/getAllTransaction",body: data).then((data) async {
                                  ...
                                  onTap: () {
                                    showMonthPicker(
                                      ...
                                      if (date != null) {
                                        ...
                                        setMonth(date);
                                        _getExpenseData(fromDate:date.month.toString(),
                                            toDate:date.year.toString());
                                      }
                                    });
                                    print("date " +
                              ...
                              child: Row(
                                ...
                                children: <Widget>[
                                  ...
                                  Container(
                                    ...
                                    child: Text(
                                      "${cnst.Inr_Rupee}${double.parse(_expenseData[0]["currentBalance"].toString()).toStringAsFixed(2)}",
                                      style: TextStyle(
                                          fontSize: 17,
                                          fontWeight: FontWeight.w600,
                                          color: Colors.white),
